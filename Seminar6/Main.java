...
class ProgramFacturi {
    ...
    static void generareRaport(String caleFisier, List<Factura> facturi) {
        class DateClient {
            ...
            @Override
            public String toString() {
                return String.format("%-30s %2d facturi, TOTAL: %8.2f RON", client, numarFacturi, total);
            }

        }

        // test = new DateClient("Testescu SRL");
        // test.numarFacturi += 3;
        ...
        Collections.sort(dateClienti, (c1, c2) -> Double.compare(c1.total, c2.total));
